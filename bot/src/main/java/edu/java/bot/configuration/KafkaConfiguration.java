...
public class KafkaConfiguration {
    ...
    public NewTopic topic() {
        return TopicBuilder
            .name(applicationConfig.topicName())
            .partitions(1)
            .replicas(1)
            .build();
    }
    ...
    @Bean
    public ConsumerFactory<String, UpdateRequest> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, UpdateRequest> containerFactory(
